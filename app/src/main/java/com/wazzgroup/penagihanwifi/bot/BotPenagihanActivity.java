...
import com.wazzgroup.penagihanwifi.client.PelangganAdapter;
...
public class BotPenagihanActivity extends AppCompatActivity {

    private ListView listView;
    private EditText searchBox;
    private ArrayList<bot> pelangganList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bot_penagihan);
        ImageView kembali = findViewById(R.id.back2);
        kembali.setOnClickListener(v -> kembaliKeList());
        Button kewa = findViewById(R.id.button2);
        kewa.setOnClickListener(v -> {
            Intent intent = new Intent(BotPenagihanActivity.this, whatsappActivity.class);
            startActivity(intent);
        });
        listView = findViewById(R.id.listPelanggan);
        searchBox = findViewById(R.id.searchPelanggan);

        adapter = new BotAdapter(this, pelangganList);
        ...
        listView.setOnItemLongClickListener((parent, view, position, id) -> {
            bot p = adapter.getItem(position);
...
//            startActivity(i);
    ...
    private void tampilkanDialogPilihan(bot p) {
        ...
        btnEdit.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(BotPenagihanActivity.this, EditPelangganActivity.class);
        ...
        btnStop.setOnClickListener(v -> {
            dialog.dismiss();
            // TODO: Kirim API untuk berhenti langganan
            Toast.makeText(this, "Berhenti langganan " + p.nama, Toast.LENGTH_SHORT).show();
        });
    ...
    private void ambilDataPelanggan(int start) {
        ...
        client.newCall(request).enqueue(new Callback() {
            @Override public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> {
                    isLoading = false;
                    Toast.makeText(BotPenagihanActivity.this, "Gagal ambil data", Toast.LENGTH_SHORT).show();
                });
            }
                ...
                runOnUiThread(() -> {
                    try {
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            p.autowa = obj.getString("auto_wa");
                            pelangganList.add(p);
                        }
                        ...
                        isLoading = false;
                        Toast.makeText(BotPenagihanActivity.this, "Format data salah", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void cariPelanggan(String keyword) {
        ...
        client.newCall(request).enqueue(new Callback() {
            @Override public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> {
                    isLoading = false;
                    Toast.makeText(BotPenagihanActivity.this, "Gagal mencari data", Toast.LENGTH_SHORT).show();
                });
            }
