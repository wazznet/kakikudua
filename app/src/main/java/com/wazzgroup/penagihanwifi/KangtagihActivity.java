...
public class KangtagihActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView settings = findViewById(R.id.profile2);
        kembali.setVisibility(View.GONE);
        settings.setVisibility(View.VISIBLE);
        settings.setOnClickListener(v -> {
            Intent intent = new Intent(KangtagihActivity.this, SettingsActivity.class);
        ...
        findViewById(R.id.menu1).setOnClickListener(v ->
                startActivity(new Intent(this, ManajemenPenagihan.class).putExtra("darihalaman", "kangtagih"))

        );

        findViewById(R.id.menu2).setOnClickListener(v ->
                startActivity(new Intent(this, TagihanLunasActivity.class).putExtra("darihalaman", "kangtagih"))
        );
//
        findViewById(R.id.menu3).setOnClickListener(v ->
                startActivity(new Intent(this, TagihanTelatActivity.class).putExtra("darihalaman", "kangtagih"))
        );

        findViewById(R.id.menu4).setOnClickListener(v ->
                startActivity(new Intent(this, TagihanNunggakActivity.class).putExtra("darihalaman", "kangtagih"))
        );
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(KangtagihActivity.this, PembayaranActivity.class);
    ...
    private void ceksaldo() {
        ...
        String Idlogin = GlobalHelper.getIdlogin(this);
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() ->
                        Toast.makeText(KangtagihActivity.this,
                ...
                runOnUiThread(() -> {
                    try {
                        ...
                        if (obj.getString("status").equals("success")) {
                            ...
                            String pemasukann = obj.getString("pemasukanperid");
                            String belummasuk = obj.getString("uangbelummasuk");
                            String belumlunas = obj.getString("belumlunas");
                            String totallunas = obj.getString("total_pelanggan_lunasperid");
                            ...
                            Toast.makeText(KangtagihActivity.this, "Update gagal: ", Toast.LENGTH_SHORT).show();

                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        Toast.makeText(KangtagihActivity.this, "Gagal parsing data", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void cariTagihan() {
        ...
        client.newCall(request).enqueue(new Callback() {
            @Override public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> Toast.makeText(KangtagihActivity.this, "Gagal cari data", Toast.LENGTH_SHORT).show());
            }
            ...
            @Override public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(() -> {
                    try {
                        ...
                        Toast.makeText(KangtagihActivity.this, "Format data salah", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
