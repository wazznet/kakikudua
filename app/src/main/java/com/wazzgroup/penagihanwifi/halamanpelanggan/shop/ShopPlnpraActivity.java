...
public class ShopPlnpraActivity extends AppCompatActivity {
            ...
            public void afterTextChanged(Editable s) {
                ...
                workRunnable = () -> {
                    if (keyword.length() >= 2) {
                        ...
                        Toast.makeText(ShopPlnpraActivity.this, "Operator tidak ditemukan", Toast.LENGTH_SHORT).show();
    ...
    private void carinomer(String keyword) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() ->
                        Toast.makeText(ShopPlnpraActivity.this, "Gagal koneksi: " + e.getMessage(), Toast.LENGTH_SHORT).show()
                );
            }
                ...
                runOnUiThread(() -> {
                    try {
                        ...
                        if (obj.getString("status").equals("success")) {
                            ...
                            Toast.makeText(ShopPlnpraActivity.this, "operator tidak di temukan ", Toast.LENGTH_SHORT).show();
                ...
                runOnUiThread(() -> {
                    try {
                        ...
                        if (obj.getString("status").equals("success")) {
                            ...
                            Intent intent = new Intent(ShopPlnpraActivity.this, PayOnline.class);
                            intent.putExtra("idtransaksi", id_pembayaran);
                            intent.putExtra("metode", pilihan);
                            startActivity(intent);
                        } else {
                            Toast.makeText(ShopPlnpraActivity.this, "Login gagal: " + obj.getString("message"), Toast.LENGTH_SHORT).show();

                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        Toast.makeText(ShopPlnpraActivity.this, "Gagal parsing data"+json+namaId, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void layanan(String operator) {
        ...
        client.newCall(request).enqueue(new Callback() {
            @Override public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> Toast.makeText(ShopPlnpraActivity.this, "Gagal ambil data", Toast.LENGTH_SHORT).show());
            }
            ...
            @Override public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(() -> {
                    try {
                        ...
                        Toast.makeText(ShopPlnpraActivity.this, "Format data salah", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
