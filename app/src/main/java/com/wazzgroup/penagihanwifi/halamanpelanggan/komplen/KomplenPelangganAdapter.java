...
public class KomplenPelangganAdapter extends ArrayAdapter<komplenpelangganku> {

    private ArrayList<komplenpelangganku> dataAsli;

    public KomplenPelangganAdapter(Context context, ArrayList<komplenpelangganku> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        komplenpelangganku t = getItem(position);
    ...
    public void filter(String text) {
        ...
        if (text.isEmpty()) {
            ...
            for (komplenpelangganku t : dataAsli) {
