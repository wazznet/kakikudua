...
public class ShopEmoneyActivity extends AppCompatActivity {
            ...
            public void afterTextChanged(Editable s) {
                ...
                workRunnable = () -> {
                    if (keyword.length() >= 2) {
                        ...
                        Toast.makeText(ShopEmoneyActivity.this, "Operator tidak ditemukan", Toast.LENGTH_SHORT).show();
    ...
    private void carinomer(String keyword) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() ->
                        Toast.makeText(ShopEmoneyActivity.this, "Gagal koneksi: " + e.getMessage(), Toast.LENGTH_SHORT).show()
                );
            }
                    ...
                    try {
                        ...
                        if (obj.getString("status").equals("success")) {
                           // String operator = obj.getString("operator");
                            ...
                            Toast.makeText(ShopEmoneyActivity.this, "operator tidak di temukan ", Toast.LENGTH_SHORT).show();
                ...
                runOnUiThread(() -> {
                    try {
                        ...
                        if (obj.getString("status").equals("success")) {
                            ...
                            Intent intent = new Intent(ShopEmoneyActivity.this, PayOnline.class);
                            intent.putExtra("idtransaksi", id_pembayaran);
                            intent.putExtra("metode", pilihan);
                            startActivity(intent);
                        } else {
                            Toast.makeText(ShopEmoneyActivity.this, "Login gagal: " + obj.getString("message"), Toast.LENGTH_SHORT).show();

                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        Toast.makeText(ShopEmoneyActivity.this, "Gagal parsing data"+json+namaId, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void layanan(String operator) {
        ...
        client.newCall(request).enqueue(new Callback() {
            @Override public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> Toast.makeText(ShopEmoneyActivity.this, "Gagal ambil data", Toast.LENGTH_SHORT).show());
            }
            ...
            @Override public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(() -> {
                    try {
                        ...
                        Toast.makeText(ShopEmoneyActivity.this, "Format data salah", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
