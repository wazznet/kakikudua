...
public class TagihanLunasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tagihan_lunas);
    ...
    private void cariTagihan(String keyword,String akses) {
        ...
        client.newCall(request).enqueue(new Callback() {
            @Override public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> Toast.makeText(TagihanLunasActivity.this, "Gagal cari data", Toast.LENGTH_SHORT).show());
            }
    ...
    private void ambilDataTagihan(String akses) {
        ...
        client.newCall(request).enqueue(new Callback() {
            @Override public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> Toast.makeText(TagihanLunasActivity.this, "Gagal ambil data", Toast.LENGTH_SHORT).show());
            }
